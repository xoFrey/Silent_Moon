...
const EditField = ({ setShowEditField, showEditField }) => {
    ...
    return <section className={`w-full bg-subtext h-96 fixed transition-transform duration-700 ease-in-out top-30 z-10 ${showEditField ? " translate-x-0" : " -translate-x-full"}`}>
