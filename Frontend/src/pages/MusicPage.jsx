...
const MusicPage = () => {
    ...
    return <>
        ...
        <div className="flex flex-col items-center justify-center gap-5 mt-10">
            ...
            <p className="text-sm font-semibold text-subtext tracking-wider mb-10 ">{playlistInfo?.description}</p>
        </div>
        <div className="flex items-center justify-evenly mb-12">
            <div className="flex items-center gap-2">
                <FaHeart fill="#E28F83" />
                <p className="text-sm text-subtext">{playlistInfo?.followers.total} Favorites</p>
            </div>
            <div className="flex items-center gap-2">
                <IoHeadset fill="#3F414E" />
                <p className="text-sm text-subtext">{playlistInfo?.followers.total + 304345} Listening</p>
            </div>
        </div>
